...
MAX_POKEMON = int(os.environ.get("MAX_POKEMON", "151"))  # Maximum Pokemon ID to seed
...
def main():
    ...
    while next_url:
        ...
        for basic_pokemon in data.get("results", []):
            ...
            if poke_id > MAX_POKEMON:
                print(f"Reached maximum Pokemon ID ({MAX_POKEMON}). Ending seeding.")
                next_url = None
                break
